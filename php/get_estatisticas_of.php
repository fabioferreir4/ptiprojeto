        ...
        case 'GET':
                if(isset($url_pieces[2]) && isset($url_pieces[3])) {
                    try {
                        ...
                        $id_veiculo = $url_pieces[3];
                        $query = "SELECT distancia, velocidade_media, consumo_medio  FROM viagem WHERE id_user = '$id_user' and id_veiculo = '$id_veiculo'" or die("Error query has failed:".mysqli_error($con));
                        $res = $con->query($query); 
